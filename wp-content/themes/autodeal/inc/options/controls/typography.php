...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'autodeal' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'autodeal' ),
				'200'        => esc_html__( 'Extra-light 200', 'autodeal' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'autodeal' ),
				'300'        => esc_html__( 'Light 300', 'autodeal' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'autodeal' ),
				'400'        => esc_html__( 'Normal 400', 'autodeal' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'autodeal' ),
				'regular'    => esc_html__( 'Normal 400', 'autodeal' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'autodeal' ),
				'500'        => esc_html__( 'Medium 500', 'autodeal' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'autodeal' ),
				'600'        => esc_html__( 'Semi-bold 600', 'autodeal' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'autodeal' ),
				'700'        => esc_html__( 'Bold 700', 'autodeal' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'autodeal' ),
				'800'        => esc_html__( 'Extra-bold 800', 'autodeal' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'autodeal' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'autodeal' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'autodeal' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'autodeal'),
			    "greek" 		=> esc_html__("Greek",'autodeal'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'autodeal'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'autodeal'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'autodeal'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'autodeal'),
			    "latin" 		=> esc_html__("Latin",'autodeal')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'autodeal' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'autodeal' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'autodeal' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'autodeal' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'autodeal' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'autodeal' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'autodeal' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
