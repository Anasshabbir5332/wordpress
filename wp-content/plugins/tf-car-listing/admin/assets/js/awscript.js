    ...
    function ct_media_upload(button_class) {
        ...
        $('body').on('click', button_class, function (e) {
            ...
            wp.media.editor.send.attachment = function (props, attachment) {
                if (_custom_media) {
                    $('#listing-type-image-id').val(attachment.id);
                    $('#listing-type-image-wrapper').html(
                        '<img loading="lazy" class="custom_media_image" src="" style="margin:0;padding:0;max-height:100px;float:none;" />'
                    );
                    $('#listing-type-image-wrapper .custom_media_image').attr('src', attachment.url)
                        .css('display', 'block');
                } else {
