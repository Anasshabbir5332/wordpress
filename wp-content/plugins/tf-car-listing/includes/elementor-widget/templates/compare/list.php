	...
	// taxonomy
	$car_condition           = get_the_terms( $listing_id, 'condition', true );
	$car_condition_att       = ! empty( $car_condition[0]->name ) ? $car_condition[0]->name : '';
	$car_fuel_type           = get_the_terms( $listing_id, 'fuel-type', true );
	$car_fuel_type_att       = ! empty( $car_fuel_type[0]->name ) ? $car_fuel_type[0]->name : '';
	...
	$car_transmission_att    = ! empty( $car_transmission[0]->name ) ? $car_transmission[0]->name : '';
	$car_make        = get_the_terms( $listing_id, 'make' );
	$car_make_att    = ! empty( $car_make[0]->name ) ? $car_make[0]->name : '';
	$car_model        = get_the_terms( $listing_id, 'model' );
	$car_model_att    = ! empty( $car_model[0]->name ) ? $car_model[0]->name : '';
	$car_body        = get_the_terms( $listing_id, 'body' );
	$car_body_att    = ! empty( $car_body[0]->name ) ? $car_body[0]->name : '';
	$car_drive_type        = get_the_terms( $listing_id, 'drive-type' );
	$car_drive_type_att    = ! empty( $car_drive_type[0]->name ) ? $car_drive_type[0]->name : '';
	$car_cylinders        = get_the_terms( $listing_id, 'cylinders' );
	$car_cylinders_att    = ! empty( $car_cylinders[0]->name ) ? $car_cylinders[0]->name : '';
	$car_car_color        = get_the_terms( $listing_id, 'car-color' );
	$car_car_color_att    = ! empty( $car_car_color[0]->name ) ? $car_car_color[0]->name : '';
	...
	?>
		<ul class="content-list">
			...
			<li class="listing-information condition">
				<p><?php echo esc_html( $car_condition_att ); ?></p>
			</li>
			...
			<li class="listing-information date">
				<p><?php echo esc_html( $car_date ); ?></p>
			</li>
