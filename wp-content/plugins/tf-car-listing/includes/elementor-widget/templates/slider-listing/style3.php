            ...
            <ul class="list-action">
                <li>
                    <a class="compare tfcl-compare-listing hv-tool" href="javascript:void(0)"
                        ...
                        <span><?php esc_html_e( 'Compare Car', 'tf-car-listing' ) ?></span>
                        <div class="icon">
                ...
                <li>
                    <a href="<?php echo get_the_permalink(); ?>">
                        <span><?php esc_html_e( 'Explore Details', 'tf-car-listing' ) ?></span>
                        <div class="icon">
                            <?php echo themesflat_svg('view'); ?>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)"
                                ...
                                data-tfcl-icon-favorited="<?php echo esc_attr( $icon_favorite ) ?>">
                                <span><?php esc_html_e( 'Add Favorite', 'tf-car-listing' ) ?></span>
                                <div class="icon">
                                <i
                                    class="<?php echo esc_attr( $css_class ); ?>" aria-hidden="true"></i>
                                </div>
                    </a>
                </li>
            </ul>
		...
		<div class="content-left">
        	<ul>
        	    <li class="listing-information">
					<div class="inner">
        	            <p class="sub"><?php esc_html_e( 'Mileage', 'tf-car-listing' ); ?></p>
        	            <p><?php echo esc_html( $car_mileage, 'tf-car-listing' ); ?></p>
					</div>
				</li>
        	    <li class="listing-information">
						<div class="inner">
        	    ...
        	    <li class="listing-information">
						<div class="inner">
        	                <p class="sub"><?php esc_html_e( 'Engine Size', 'tf-car-listing' ); ?></p>
                            <p><?php echo esc_html( $car_engine_size, 'tf-car-listing' ); ?></p>
						</div>
				</li>
        	    <li class="listing-information">
						<div class="inner">
        	                <p class="sub"><?php esc_html_e( get_option('custom_name_cylinders') ); ?></p>
