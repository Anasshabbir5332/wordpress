(function ($) {
    ...
    var changeUrl = function () {
        ...
        $('.tf-search-wrap #search_keyword').on('change', function () {
            var var1 = $(this).val();
            $(this).closest('.search-listing-form').find('.search-input').val(var1);
            var $this = $(this);
            updateUrl($this);
            loadQuantityListing();
        });

        $('.tf-search-wrap #search_engine_size').on('change', function () {
            var $this = $(this);
            updateUrl($this);
            loadQuantityListing();
        });
