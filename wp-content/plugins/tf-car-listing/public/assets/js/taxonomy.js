(function ($) {
    ...
    var executeSearchListing = function () {
        ...
        $('.tfcl-advanced-search-wrap .btn-condition-filter, .listing-list-wrap .btn-condition-filter, .btn-apply-filter').on('click', function () {
            var $this = $(this);
        ...
        $('.search-listing-form .tfcl-form-top [name="keyword"], .search-listing-form .tfcl-form-top [name="engine_size"], .search-filter-wrap [name="keyword"], .search-filter-wrap [name="engine_size"]').on('change', function () {
            var $this = $(this);
            updateUrl($this);
            filterListingAjax();
        });
    ...
    var buttonResetFilter = function () {
        $("body").on("click", ".btn-clear-filter", function () {
            ...
            $(this).closest('body').find('.search-listing-form input').val('');
