    ...
    $("#tfcl_change_pass").on('click', function () {
      ...
      if ($form.valid()) {
        $.ajax({
          ...
          beforeSend: function () {
            $("#tfcl_change_pass").addClass('btn-loading');
            $messages.empty().append('<span class="success text-success"> Loading <i class="fa fa-spinner fa-spin"></i></span>');
          },
          success: function (response) {
            $("#tfcl_change_pass").removeClass('btn-loading');
            if (response.success) {
              $messages.empty().append('<span class="success text-success"><i class="fa fa-check"></i> ' + response.message + '</span>');
    ...
    $('#tfcl_become_dealer').on('click', function () {
      ...
      if (confirmed) {
        $.ajax({
          ...
          beforeSend: function () {
            $('#tfcl_become_dealer').addClass('btn-loading');
            $messages.empty().append('<span class="success text-success"> Loading <i class="fa fa-spinner fa-spin"></i></span>');
          },
          success: function (response) {
            $('#tfcl_become_dealer').removeClass('btn-loading');
            if (response.status) {
              $messages.empty().append('<span class="success text-success"><i class="fa fa-check"></i> ' + response.message + '</span>');
              setTimeout(() => {
                window.location.reload();
    ...
    $('#tfcl_remove_dealer').on('click', function () {
      ...
      if (confirmed) {
        $.ajax({
          ...
          beforeSend: function () {
            $('#tfcl_remove_dealer').addClass('btn-loading');
            $messages.empty().append('<span class="success text-success"> Loading <i class="fa fa-spinner fa-spin"></i></span>');
          },
          success: function (response) {
            $('#tfcl_remove_dealer').removeClass('btn-loading');
            if (response.status) {
              $messages.empty().append('<span class="success text-success"><i class="fa fa-check"></i> ' + response.message + '</span>');
              setTimeout(() => {
                window.location.reload();
