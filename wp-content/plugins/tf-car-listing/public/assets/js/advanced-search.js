    ...
    advancedSearch = {
        ...
        executeAdvancedSearch: function () {
            ...
            $('.tf-advanced-search-btn').on('click', function (e) {
                ...
                $('.search-form-content .search-field, .search-form-content #search_keyword, .search-form-content #search_engine_size, .tf-search-condition-tab .search-field, .search-more-options .search-field').each(function () {
                    var $this = $(this),
