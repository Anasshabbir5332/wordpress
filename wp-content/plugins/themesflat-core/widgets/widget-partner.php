		...
		foreach ( $settings['list'] as $index => $item ) {
			...
			if ($item['image'] != '') {
				$image = sprintf( '<div class="image">
					<a href="%2$s" %3$s %4$s><img src="%1$s" width="190" height="80" alt="image"></a>
			...
			foreach ( $settings['list2'] as $index => $item2 ) {
				...
				$icon_text = \Elementor\Addon_Elementor_Icon_manager_autodeal::render_icon( $item2['icon_text'], [ 'aria-hidden' => 'true' ]);
