...
$theme = wp_get_theme();
if ( 'autodeal' == $theme->name || 'autodeal' == $theme->parent_theme ) {
...
final class ThemesFlat_Addon_For_Elementor_autodeal {
    ...
    public function init_widgets() {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFListImage_Widget_Free() ); 

        require_once( __DIR__ . '/widgets/widget-image-with-list.php' );
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \TFImageWithList_Widget() ); 
    ...
    public function widget_styles() {
        ...
        wp_register_style( 'tf-imagebox', plugins_url( '/assets/css/image/tf-image.css', __FILE__ ) );
        ...
        wp_register_style( 'partner', plugins_url( '/assets/css/partner/tf-partner.css', __FILE__ ) );
        wp_register_style( 'tf-accordion', plugins_url( '/assets/css/accordion/tf-accordion.css', __FILE__ ) );
        wp_register_style( 'tf-tab', plugins_url( '/assets/css/tabs/tf-tabs.css', __FILE__ ) );
        wp_enqueue_style( 'tf-animated', plugins_url( '/assets/css/tf-animated.css', __FILE__ ) );
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'tf-tab', plugins_url( '/assets/js/tabs/tf-tabs.js', __FILE__ ), [ 'jquery' ], false, true );
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_autodeal::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
...
ThemesFlat_Addon_For_Elementor_autodeal::instance();
